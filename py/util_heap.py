...
class MedianFinder:
    ...
    def insert(self, val):
        # print("insert 1", self.__minHeap.sort(), self.__maxHeap.sort())
        self.__minHeap.insert(val)
        # print("insert 2", self.__minHeap.sort(), self.__maxHeap.sort())
        self.__maxHeap.insert(self.__minHeap.deque())
        # print("insert 3", self.__minHeap.sort(), self.__maxHeap.sort())
        self.adjust()
        # print("insert 4", self.__minHeap.sort(), self.__maxHeap.sort())
    ...
    def getMedian(self):
        # print("getMedian", self.__minHeap.sort(), self.__maxHeap.sort())
...
class HeapTest(unittest.TestCase):
    ...
    def test_median_finder(self):
        ...
        finder = MedianFinder()
        finder.insert(1)
        self.assertEqual(finder.getMedian(), 1)
        finder.insert(2)
        self.assertEqual(finder.getMedian(), 1.5)
        finder.insert(3)
        self.assertEqual(finder.getMedian(), 2)
        finder.insert(1)
        self.assertEqual(finder.getMedian(), 1.5)
        finder.insert(1)
        self.assertEqual(finder.getMedian(), 1)
        ...
        # 1 1 2 3 4 5
        self.assertEqual(finder.getMedian(), 2.5)
        self.assertTrue(finder.remove(2))
        # 1 1 3 4 5
        self.assertEqual(finder.getMedian(), 3)
        ...
        self.assertTrue(finder.remove(1))
        # 3 4
        self.assertEqual(finder.getMedian(), 3.5)
        self.assertFalse(finder.remove(1))
        # 3 4
        self.assertEqual(finder.getMedian(), 3.5)
        self.assertTrue(finder.remove(3))
        # 4
        self.assertEqual(finder.getMedian(), 4)
        ...
        for i in range(len(nums)):
            ...
            if (len(finder2) % 2 == 0):
                self.assertEqual(finder2.getMedian(),
                                 (nums[mIdx - 1] + nums[mIdx]) / 2)
            else:
                self.assertEqual(finder2.getMedian(), nums[mIdx])
