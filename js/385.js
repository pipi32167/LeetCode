...
NestedInteger.prototype.isInteger = function () {
  return this._integer !== null && this._list === null
};
...
var assert = require('assert')
assert.deepEqual(deserialize("1"), deserialize2("1"));
assert.deepEqual(deserialize("123"), deserialize2("123"));
assert.deepEqual(deserialize("[]"), deserialize2("[]"));
assert.deepEqual(deserialize("[[]]"), deserialize2("[[]]"));
assert.deepEqual(deserialize("[-1]"), deserialize2("[-1]"));
assert.deepEqual(deserialize("[-1,-2]"), deserialize2("[-1,-2]"));
assert.deepEqual(deserialize("[123,456,[788,799,833],[[]],10,[]]"), deserialize2("[123,456,[788,799,833],[[]],10,[]]"));
